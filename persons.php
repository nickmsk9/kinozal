...
<div class="mn_wrap">
	...
	<div class="mn1_menu"><ul class="men w200">
		...
		<?php if ($pid > 0 && $hash !== '') { ?><li><span class="bulet"></span><?= tracker_post_action_link('/bookmarks.php', array('type' => 4, 'bookmark_action' => 'add', 'target_id' => $pid), 'Добавить в закладки', 'sba', 'Добавить персону в закладки?') ?></li><?php } ?>
