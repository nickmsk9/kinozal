...
<tr><td class=embedded colspan=11>&nbsp;</td></tr>
<tr><td class=embedded colspan=11><b>Редакторы</b></td></tr>
<tr><td class=embedded colspan=11><hr color="#4040c0" size=1></td></tr>
<tr height=15>
<?=$staff_table[UC_MODERATOR]?>
</tr>
<tr><td class=embedded colspan=11>&nbsp;</td></tr>
<tr><td class=embedded colspan=11><b>Кинооператоры</b></td></tr>
<tr><td class=embedded colspan=11><hr color="#4040c0" size=1></td></tr>
<tr height=15>
...
<? end_frame(); ?>
<br />
<? begin_frame("Редакторы и средства - <font color=#004E98>Видно редакторам.</font>"); ?>
...
<td class=embedded><form method=get action=uploaders.php><input type=submit value="Кинооператоры" style='height: 20px; width: 100px'></form></td>
</tr>
<tr>
...
<option value=0>Зритель</option>
<option value=1>Опытный Зритель</option>
<option value=2>ВИП</option>
<option value=3>Кинооператор</option>
<option value=4>Редактор</option>
<option value=5>Администратор</option>
<option value=6>Директор</option>
</select>
