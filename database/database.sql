...
CREATE TABLE `peers` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `torrent_user_peer` (`torrent`,`userid`,`peer_id`),
  KEY `torrent` (`torrent`),
  KEY `torrent_id` (`torrent`,`id`),
  KEY `torrent_seeder` (`torrent`,`seeder`),
  KEY `torrent_seeder_action_id` (`torrent`,`seeder`,`last_action`,`id`),
  KEY `last_action` (`last_action`),
  KEY `connectable` (`connectable`),
  KEY `userid` (`userid`),
  KEY `userid_seeder_action` (`userid`,`seeder`,`last_action`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `snatched` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `snatched_torrent_user` (`torrent`,`userid`),
...
CREATE TABLE `users` (
  ...
  `passkey_ip` varchar(45) NOT NULL default '',
  PRIMARY KEY  (`id`),
