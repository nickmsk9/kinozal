...
return array('language_charset' => 'utf8mb4',
			 ...
			 'signup_i_will_read_faq' => 'Я буду задавать вопросы только после чтения правил',
			 ...
			 'class_honor_user' => 'Заслуженный Зритель',
			 'class_manager' => 'Менеджер',
			 'class_moderator' => 'Редактор',
			 'class_power_user' => 'Опытный Зритель',
			 'class_senior_uploader' => 'Главный Кинооператор',
			 'class_sysop' => 'Директор',
			 'class_uploader' => 'Кинооператор',
			 'class_user' => 'Зритель',
			 'class_vip' => 'ВИП',
			 'client' => 'Клиент',
