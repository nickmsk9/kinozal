...
$trust_proxy_headers = false; // Доверять X-Forwarded-For/X-Real-IP только от trusted proxy.
$trusted_proxy_ips = array_filter(preg_split('/\s*,\s*/', (string)(getenv('KZ_TRUSTED_PROXIES') ?: ''))); // Например: 127.0.0.1,::1,172.18.0.0/16
