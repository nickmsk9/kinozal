...
- Добавлены миграции: `database/20260620_audit_p0.sql`, `database/20260620_password_hash.sql`, `database/20260620_passkey_v3.sql`.

Осталось: TTL для reset-token отдельной колонкой, хеширование passkey в БД, перевод всех GET-мутаций на POST без совместимого режима, EXPLAIN на живой БД, тестовый контур/CI.
